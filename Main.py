...
print("Olá! Seja bem-vindo ao ROBlOX!")
...
while True:
    ...
    choice = int(input())
    if choice == 1:
        Conta1.ComprarRobux(int(input("Digite o valor que deseja comprar: ")))
    elif choice == 2:
        Conta1.AdicionarTix(int(input("Digite a quantidade que deseja adicionar: ")))
    elif choice == 3:
